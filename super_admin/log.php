                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        ...
                                        <a href="<?php echo $base_url; ?>super_admin/teacher_logs.php?page_no=<?php echo $_GET['page_no'] ?>" class="btn btn-info">Go Back</a>
                                        <?php else: ?>
                                        <a href="<?php echo $base_url; ?>super_admin/teacher_logs.php" class="btn btn-info">Go Back</a>
                                        <?php endif ?>
                                    </div>
                                </div>
                            </div>
